...
The Meeting was called to order at 4 pm on July 07, 2023, via Zoom
...
Gopi Raju Rajolu: I started working on Issue #42(Creating the initial data in the database, based on genre). Once I am done with this issue, I will pick Issue #45(Create a table in the database for Movie details).
...
Anil Boyapati: I started working on Issue #26 (Creating the initial data in the database which includes the availability of ticket), once I am done with this issue, I will pick Issue #29 (No credentials are required to sign in as a visitor).
...
The next meeting will be on 11 July 2023 on Zoom
